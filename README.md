...
この開発では仕様を考えると同時に、ゲーム実装を行っていました。開発途中では、企画の方向性に迷ったりチームメンバーとの方向性が合わず開発に苦戦する時期がありました。
最終的にはゲームを作りきることができませんでしたが、チーム内の方向性の決め方や、チーム内のコミュニケーションの接し方など、現在のチーム開発に活かせるいい経験をすることができました。
