...
- 役割  
[前回の制作](https://github.com/hamster3156/CyberBlade)に引き続き、プログラマー兼プランナーとしてゲーム開発を行いました。日本ゲーム大賞に作品を過ぎた時期から、ゲーム企画を考えるよりもプログラマーとして実装している方が向いてると感じ、6月以降からプログラマーとして開発に関わりました。  
